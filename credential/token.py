...
def set_token(token):
    """
    Responsible for receive the customer token and create the access_key via API request
    """
...
def get_token():
    """
    Used to return the access_token, also, this is the definition responsible to check
    the expiration time, once the current time is == or >, the refresh call will be made.
    """
